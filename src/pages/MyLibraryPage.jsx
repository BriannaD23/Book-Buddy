...
//   const [bookListType, setBookListType] = useState(null); // Track the list type (Current or Pending)
...
//     setSelectedBook(bookId); // Store the clicked book
...
//     addBookToPending(book)
//       .then(() => {
//         setPendingBooks((prev) => [...prev, book]);
//         setShowModal(false);
//       })
//       .catch((err) => {
//         setError("Failed to add book to pending list");
//         console.error(err);
//       });
//   };
...
//                             className="bg-black bg-opacity-50 text-white p-3 rounded-full hover:bg-opacity-75 transition-opacity mx-2"
//                           >
//                             Add
//                           </button>
//                           <button
...
//             <h2 className="text-2xl mb-4 text-[#9B2D2D]">
//               Add book to list
//             </h2>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <div className="mt-4">
              <button
                onClick={() => handleAddToList(selectedBook)} // Pass the selectedBook object
                className="bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600"
              >
                Add to Current
              </button>
